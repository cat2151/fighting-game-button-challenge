...
def load_game_configuration():
    ...
    (names, plus, lever_names, missions, none_word) = load_all_configs(args)
    return args, names, plus, lever_names, missions, none_word
...
def load_all_configs(args):
    ...
    return names, plus, lever_names, args.missions, none_word
