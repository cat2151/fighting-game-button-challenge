...
- 特徴
    ...
    - ホットリロード
        - TOML設定ファイルを編集すると、アプリを再起動せずに自動で設定が反映されます
        - デバッグ表示のon/off切り替えや、技のメンテナンスに便利です
        - リロード後はPhase 1の最初から自動でやり直しになります
        - 詳細は [docs/hot_reload.md](docs/hot_reload.md) を参照
- 動作確認した環境
    - Windows
    - XInput
    - アーケードコントローラー
...
---
Generated at: 2026-03-17 07:09:10 JST
